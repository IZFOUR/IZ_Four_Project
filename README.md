<공지사항>
dev : 가장 최근 파일입니다.
실행해보시고 오류,에러 여기다 적어주시거나 말씀해주세요.
번역이랑 가로모드는 어쩌다보 못건드렸네요. 수정가능하시면 부탁드려요
그리고 마지막으로 디자인좀 부탁드립니다. 
...
[FIX] : 🐛 08.21 am 05:00
1. 1차적으로 전체 최적화
2. MyAbilityDetail에서 프로그레스바 클릭하지 않고 저장했을때 
3. MyAbility갔다가 다시 돌아오면 프로그레스바 초기화되던부분 수정
   
[FIX] : 🐛 08.21 am 06:10
1. 2차 전체 최적화
2. 프로그레스바 팅김현상, deadline초기값 설정
3. 레이아웃 수정
